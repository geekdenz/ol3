goog.provide('ol.tilegrid.TileCacheTileGrid');
 ...
 * @param {ol.tilegrid.TileCacheTileGridOptions} options TileCacheTileGrid options.
 */
ol.tilegrid.TileCacheTileGrid = function(options) {
  var resolutions;
  var z;
  ...
  if (options.resolutions) {
    ...
    resolutions = new Array(options.maxZoom + 1);
...
goog.inherits(ol.tilegrid.TileCacheTileGrid, ol.tilegrid.TileGrid);


/**
 * @inheritDoc
 */
ol.tilegrid.TileCacheTileGrid.prototype.createTileCoordTransform = function(opt_options) {
 ...
 * @inheritDoc
 */
ol.tilegrid.TileCacheTileGrid.prototype.getTileCoordChildTileRange =
 ...
 * @inheritDoc
 */
ol.tilegrid.TileCacheTileGrid.prototype.forEachTileCoordParentTileRange =
